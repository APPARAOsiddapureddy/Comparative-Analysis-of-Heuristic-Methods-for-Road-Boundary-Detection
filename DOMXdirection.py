...
from sort2 import *
import numpy as np
from DOM_x import intialize_x_direction
...
x_l_l_l_b_Id, x_l_l_r_b_Id, x_r_l_l_b_Id, x_r_l_r_b_Id, total_foreground = intialize_x_direction()

cap2 = cv2.VideoCapture("../Videos/footage_4.mp4")
model2 = YOLO("./YOLOWeights/yolov8n.pt")
tracker2 = Sort(max_age=20, min_hits=3, iou_threshold=0.3)

l_l_l_b_Id, l_l_r_b_Id, r_l_l_b_Id, r_l_r_b_Id = x_l_l_l_b_Id, x_l_l_r_b_Id, x_r_l_l_b_Id, x_r_l_r_b_Id
...
while True:
    ...
    for result in resultsTracker:
        ...
        if l_l_l_b_Id in tracking_obj2:
            ...
            l_l_b_points.append((prev_pt[0] + prev_pt[2]//2, prev_pt[1]))
            if Id == l_l_l_b_Id:
        ...
        if l_l_r_b_Id in tracking_obj2:
            ...
            l_r_b_points.append((prev_pt[0] + prev_pt[2]//2, prev_pt[1] + prev_pt[3]))
            if Id == l_l_r_b_Id:
        ...
        if r_l_l_b_Id in tracking_obj2:
            ...
            r_l_b_points.append((prev_pt[0] + prev_pt[2]//2, prev_pt[1]))
            if Id == r_l_l_b_Id:
        ...
        if r_l_r_b_Id in tracking_obj2:
            ...
            r_r_b_points.append((prev_pt[0] + prev_pt[2]//2, prev_pt[1] + prev_pt[3]))
            if Id == r_l_r_b_Id:
...
print((l_l_b_points_avg_x, l_l_b_points_avg_y))
...
print((l_r_b_points_avg_x, l_r_b_points_avg_y))
...
print((r_l_b_points_avg_x, r_l_b_points_avg_y))
...
print((r_r_b_points_avg_x, r_r_b_points_avg_y))
